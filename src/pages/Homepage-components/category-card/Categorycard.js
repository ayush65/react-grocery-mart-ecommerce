...
const  Categorycard = () =>  {
  ...
  <div className="card-grid">
              ...
              <Link  to= "/productListing" key={categories[0]._id} 
              ...
              <Link  to= "/productListing" key={categories[1]._id} 
              className="card card-shadow"
              onClick={() => {
              ...
              <Link  to= "/productListing" key={categories[2]._id} 
              className="card card-shadow"
              onClick={() => {
              ...
              <Link  to= "/productListing" key={categories[3]._id} 
              className="card card-shadow"
              onClick={() => {
              ...
              <Link  to= "/productListing" key={categories[4]._id} 
              className="card card-shadow"
              onClick={() => {
              ...
              <Link  to= "/productListing" key={categories[5]._id} 
              className="card card-shadow"
              onClick={() => {
              ...
              <Link  to= "/productListing" key={categories[6]._id} 
              className="card card-shadow"
              onClick={() => {
              ...
              <Link  to= "/productListing" key={categories[7]._id} 
              className="card card-shadow"
              onClick={() => {
